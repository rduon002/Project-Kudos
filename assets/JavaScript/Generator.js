$(document).ready(function () {
  ...
  /*function delQuiz(e) {
    e.preventDefault();
    firebase.database().ref($(this).currentQuiz).remove(currentQuiz.questions).then(function () {
  ...
  function removeQuiz(e) {
    e.preventDefault();
    firebase.database().ref($(this).currentQuiz).remove().then(function () {
      console.log("remove succeeded.");
    }).catch(function (error) {
      console.log("remove failed: " + error.message);
    });
